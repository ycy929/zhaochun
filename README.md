...
### 保持最新代码
随着职校家园的更新，自动打卡可能会在某个版本后失效，开发者会及时更新代码，但你Fork的代码并无法保证与主分支（我的代码）实时同步，此时需要手动同步代码，需要注意的是Github不会有任何通知告诉你代码过时或有新版发布，为此，你可以在微信中关注公众号：XuanRan，当有重要更新或调整时会在公众号发文提醒。
